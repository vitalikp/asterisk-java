 ...
 *
 * <p>Input ends when the timeout is reached, the maximum number of digits is read
 * or the user presses #.
 *
 * @author srt
...
public class GetDataCommand extends AbstractAgiCommand
{
     ...
     *
     * <p>0 means standard timeout value, -1 means "ludicrous time" (essentially
     * never times out).
     */
