...
public enum ManagerConnectionState
{
     ...
     *
     * <p>Changes to {@link #CONNECTING} when {@link org.asteriskjava.manager.ManagerConnection#login()}
     * is called.
     */
    INITIAL,
     ...
     *
     * <p>Changes to {@link #CONNECTED} when login has successfully completed or
     ...
     *
     * <p>This is the required state for sending actions to the Asterisk server.
     *
     * <p>Changes to {@link #RECONNECTING} when connection is lost or {@link #DISCONNECTING}
     ...
     *
     * <p>Changes to {@link #CONNECTED} when connection is successfully reestablished or
     ...
     *
     * <p>Changes to {@link #DISCONNECTED} when connection has been closed.
     */
    DISCONNECTING,
     ...
     *
     * <p>Can be changed to {@link #CONNECTING} by calling
