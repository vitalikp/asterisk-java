 ...
 * implement.
 *
 * <p>Instances of this class represent a command sent to Asterisk via Manager API,
 ...
 * engine.
 *
 * <p>There is one concrete subclass of ManagerAction per each supported Asterisk
 * Action.
 *
 * @author srt
 * @version $Id: ManagerAction.java 397 2006-05-26 12:13:32Z srt $
 */
public interface ManagerAction extends Serializable
{
     ...
     * Sets the action id.
     *
     * <p>If the action id is set and sent to the asterisk server any response
     ...
     * responses and response events.
     *
     * <p>Note that Asterisk-Java uses its own internal action id to match
